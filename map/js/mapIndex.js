...
function useTheData(doc) {
  ...
  //soton location
    ...
    ///SOCKET WORK
     ...
     var socket = io.connect('http://sotonwo.cloudapp.net:3005');

    socket.on('twitter_uk_southampton', function (data) {
              tweetsSoton = tweetsSoton +1;
              counters["tweetsSoton"] = tweetsSoton;
